...
for (species in species_list) {
  ...
  tryCatch({
    ...
    full_model_formula <- paste0(width_col, " ~ Year * deer + Year * worms + deer * worms + I.", species, " + (1 | site/Row)")
    full_model <- lmer(as.formula(full_model_formula), data = d4)
    
    reduced_models_formulas <- c(
      paste0(width_col, " ~ Year + deer + worms + I.", species, " + (1 | site/Row)"),
      paste0(width_col, " ~ Year * deer + worms + I.", species, " + (1 | site/Row)"),
      paste0(width_col, " ~ Year * worms + deer + I.", species, " + (1 | site/Row)"),
      paste0(width_col, " ~ deer * worms + Year + I.", species, " + (1 | site/Row)")
    )
