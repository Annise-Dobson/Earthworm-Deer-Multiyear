...
for (species in species_list) {
  ...
  tryCatch({
    ...
    full_model_formula <- paste0(survival_col, " ~ Year * deer + Year * worms + deer * worms + I.", species, " + (1 | site/Row)")
    full_model <- glmer(as.formula(full_model_formula), family=binomial, data = d4)
    
    reduced_models_formulas <- c(
      paste0(survival_col, " ~ Year + deer + worms + I.", species, " + (1 | site/Row)"),
      paste0(survival_col, " ~ Year * deer + worms + I.", species, " + (1 | site/Row)"),
      paste0(survival_col, " ~ Year * worms + deer + I.", species, " + (1 | site/Row)"),
      paste0(survival_col, " ~ deer * worms + Year + I.", species, " + (1 | site/Row)")
    )
