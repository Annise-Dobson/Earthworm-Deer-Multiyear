...
for (species in species_list) {
  ...
  tryCatch({
    ...
    full_model_formula <- paste0(insect_col, " ~ Year * deer + Year * Drybiomass.mean + deer * Drybiomass.mean + I.", species, " + (1 | site/Row)")
    full_model <- glmer(as.formula(full_model_formula),family=binomial, data = d4)
    
    reduced_models_formulas <- c(
      paste0(insect_col, " ~ Year + deer + Drybiomass.mean + I.", species, " + (1 | site/Row)"),
      paste0(insect_col, " ~ Year * deer + Drybiomass.mean + I.", species, " + (1 | site/Row)"),
      paste0(insect_col, " ~ Year * Drybiomass.mean + deer + I.", species, " + (1 | site/Row)"),
      paste0(insect_col, " ~ deer * Drybiomass.mean + Year + I.", species, " + (1 | site/Row)")
    )
