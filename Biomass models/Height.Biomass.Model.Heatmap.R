...
for (species in species_list) {
  ...
  tryCatch({
    ...
    full_model_formula <- paste0(height_col, " ~ Year * deer + Year * Drybiomass.mean + deer * Drybiomass.mean + I.", species, " + (1 | site/Row)")
    full_model <- lmer(as.formula(full_model_formula), data = d4)
    
    reduced_models_formulas <- c(
      paste0(height_col, " ~ Year + deer + Drybiomass.mean + I.", species, " + (1 | site/Row)"),
      paste0(height_col, " ~ Year * deer + Drybiomass.mean + I.", species, " + (1 | site/Row)"),
      paste0(height_col, " ~ Year * Drybiomass.mean + deer + I.", species, " + (1 | site/Row)"),
      paste0(height_col, " ~ deer * Drybiomass.mean + Year + I.", species, " + (1 | site/Row)")
    )
